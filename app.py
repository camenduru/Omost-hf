...
with gr.Blocks(
    ...
    with gr.Row(elem_classes='outer_parent'):
        with gr.Column(scale=25):
            ...
            with gr.Row():
                gr.Markdown("Note that you can only occupy HuggingFace ZeroGPU 170 seconds every 5 minutes. If connection error out, wait 5 minites and try again. Besides, interrupting generation is only available in local version because of ZeroGPU's design.")
